...
router.post('/create',validateExperience,catchAsync(interviewExperienceController.postCreateExperience));
...
router.put('/:id',validateExperience,catchAsync(interviewExperienceController.postEditExperience));
